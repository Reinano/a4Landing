                  ...
                  <div className="emission__innerWrapper">
                    <div className="emission__graphContainer relative">
                        <div className='emission__badge emission__badge_1'>
                            ...
                            <div className="emission__badge_questionicon"></div>
                        </div>
                        ...
                        <div className='emission__badge emission__badge_6'>
                            ...
                            <span className="emission__badgeSpan emission__badgeSpan_6">{_t('emission-item-6')}</span>
                            <div className="emission__badge_questionicon"></div>
                        </div>
                    ...
                    <div className="emission__info">
                      ...
                      <h2 className="emission__title">1 {_t('emission-title')}<span className="emission__title_icon"></span></h2>
                      <p className="emission__desc emission__desc_a4tokens">1 000 000 000 000<span className="emission__desc_a4spanTwo">A4 {_t('emission-A4-tokens')}</span></p>
                    </div>
